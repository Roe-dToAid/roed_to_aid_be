...
RSpec.describe 'Authorized Clinic Endpoint', type: :request do
  ...
  describe 'happy path' do
    describe 'index endpoint' do
      it 'returns all authorized clinics' do
        state = State.create!(name: 'Texas', abbreviation: 'TX', legal: 2, legal_description: 'banned as heck',
                              source: 'website')
        state2 = State.create!(name: 'New Mexico', abbreviation: 'NM', legal: 0, legal_description: 'fully legal',
                               source: 'website')

        clinic1 = AuthorizedClinic.create!(state_id: state.id, name: 'Planned Parenthood',
                                           address: 'its sad because there actually arent any clinics in TX', city: 'Houston', zip: 87_108, phone: '5555555555', services: 'pill, clinic', website: 'a super cool webpage')
        clinic2 = AuthorizedClinic.create!(state_id: state2.id, name: 'Fake Clinic', address: '123 Seaside Ln',
                                           city: 'Atlantis', zip: 87_345, phone: '4556439900', services: 'clinic', website: 'another super cool webpage')
    ...
    describe 'show endpoint' do
      it 'returns successful but empty with no clinics' do
        ...
        clinic1 = AuthorizedClinic.create!(state_id: state2.id, name: 'Planned Parenthood',
                                           address: 'its sad because there actually arent any clinics in TX', city: 'Houston', zip: 87_108, phone: '5555555555', services: 'pill, clinic', website: 'a super cool webpage')
        clinic2 = AuthorizedClinic.create!(state_id: state2.id, name: 'Fake Clinic', address: '123 Seaside Ln',
                                           city: 'Atlantis', zip: 87_345, phone: '4556439900', services: 'clinic', website: 'another super cool webpage')
  ...
  describe 'sad path' do
    describe 'show endpoint' do
      it 'returns error message if not a propper abbreviation' do
        state = State.create!(name: 'Texas', abbreviation: 'TX', legal: 2, legal_description: 'banned as heck',
                              source: 'website')
        state2 = State.create!(name: 'New Mexico', abbreviation: 'NM', legal: 0, legal_description: 'fully legal',
                               source: 'website')
        ...
        get '/api/v1/states/not_correct/authorized_clinics', params: body
